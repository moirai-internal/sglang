...
class DeepSeekR1Detector(BaseReasoningFormatDetector):
    ...
    def parse_streaming_increment(self, new_text: str) -> StreamingParseResult:
        ...
        if not self._in_reasoning and self.think_start_token in current_text:
            ...
            return StreamingParseResult(
                normal_text=normal_text, reasoning_text=reasoning_text.lstrip()
            )
...
DETECTOR_MAP: Dict[str, BaseReasoningFormatDetector] = {
...
class ReasoningParser:
    ...
    def __init__(self, model_type: str = None, stream_reasoning: bool = True):
        ...
        detector_class = DETECTOR_MAP.get(model_type.lower())
